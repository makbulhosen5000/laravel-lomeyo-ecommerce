...
<header class="font-display">
            ...
            <div class="container px-3 md:px-5 xl:px-0">
                <div class="flex justify-between items-center py-5">
                    ...
                    <div class="lg:block hidden">
                        ...
                        @include('frontend.pertials.cart')
                    ...
                    <ul class="lg:flex gap-8 items-center hidden main-menu">
                        ...
                        <li class="relative">
                            <a href="javascript:void(0);" class="inline-flex gap-2 items-center">Pages
                                <span>
                                    <img src="{{ asset('frontend') }}/public/assets/images/all-img/select-arrow.png"
                                        alt="">
                                </span>
                            </a>
                            <ul>
    ...
    <div class="nav-menu" id="nav-menu">
        <div class="flex justify-between  items-center px-3 py-4 mb-4">
            <div>
                <a href="#">
                    <img src="{{ asset('frontend') }}/public/assets/images/all-img/logo-sm.png" alt="">
                </a>
            </div>
