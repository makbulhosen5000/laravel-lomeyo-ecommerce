            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend') }}/public/assets/images/all-img/f-product-01.png"
                                    alt="">
                ...
                <div class="swiper-slide">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend') }}/public/assets/images/all-img/f-product-02.png"
                                    alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                ...
                <div class="swiper-slide">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend') }}/public/assets/images/all-img/f-product-03.png"
                                    alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                ...
                <div class="swiper-slide">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend') }}/public/assets/images/all-img/f-product-04.png"
                                    alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
