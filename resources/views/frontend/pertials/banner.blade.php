...
<section
            ...
            <div class="swiper-slide">
                <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                    ...
                    <div class="md:w-1/2 w-full flex justify-center items-center relative">
                        <img src="{{ asset('frontend') }}/public/assets/images/all-img/chair.png" alt="">
                        <div class="inline-block absolute top-0 right-0">
                            <img src="{{ asset('frontend') }}/public/assets/images/all-img/discount.png" alt="">
    ...
    <img src="{{ asset('frontend') }}/public/assets/images/svg/banner-shapes.svg" alt=""
